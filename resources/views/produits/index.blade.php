...
@section('content')
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('produits.create') }}" class="btn btn-success btn-sm" title="Add New Produit">
                                ...
                                @foreach($produits as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/produits/' . $item->id . '/edit') }}" title="Edit Produit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
    ...
    {{-- <div style="margin-left:15px">{{ $produits->links() }}</div> --}}
